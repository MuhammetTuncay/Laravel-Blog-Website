...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link @if(Request::segment(2)=="makaleler") in @endif" href="#" data-toggle="collapse" data-target="#collapseTwo"
        ...
        <li class="nav-item">
            <a class="nav-link @if(Request::segment(2)=="sayfalar") in @endif" href="#" data-toggle="collapse" data-target="#collapsePage"
